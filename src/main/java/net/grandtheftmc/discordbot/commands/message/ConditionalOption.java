...
public enum ConditionalOption {
    ...
    RANK(String.class, "rank", "What donator rank should receive this message?"),
    ...
    LAST_PLAYED(String.class, "last-played", "How long ago must the user have last played to receive the message. (format: yyyy-mm-dd)"),
